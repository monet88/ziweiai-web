...
<main class="celestial-page">
  ...
  <div class="shell">
    ...
    <!-- TẦNG B2B: GIẢI PHÁP PHONG THỦY & VẬN MỆNH CHO BĐS, XÂY DỰNG & DOANH NGHIỆP -->
    <section class="b2b-enterprise-section">
      <div class="b2b-container">
        <div class="b2b-header text-center">
          <div class="eyebrow-tag b2b-eyebrow center">
            <Building2 size={15} class="text-indigo-400" />
            <span>GIẢI PHÁP ĐỘT PHÁ DOANH NGHIỆP</span>
          </div>
          <h2 class="section-heading b2b-heading">
            Dành Riêng Cho Chuyên Viên Bất Động Sản, Xây Dựng & Chủ Doanh Nghiệp
          </h2>
          <p class="b2b-subheading">
            Thấu hiểu đại vận tài lộc đối tác, chọn ngày giờ khởi công động thổ vượng khí và may đo ấn bản Hồ Sơ Hoàng Gia 19 Trang PDF làm quà tri ân sang trọng chốt giao dịch tiền tỷ.
          </p>
        </div>

        <div class="b2b-cards-grid">
          <div class="b2b-feature-card">
            <div class="b2b-icon-wrap icon-realty">
              <Building2 size={24} />
            </div>
            <h3 class="b2b-card-title">Tư Vấn Phong Thủy & Động Thổ</h3>
            <p class="b2b-card-desc">
              Tra cứu hướng sinh khí, tính ngày giờ khởi công, nhập trạch, mở bán dự án theo phong thủy Lục Nhâm - Kỳ Môn - Bát Tự, giúp gia tăng niềm tin tuyệt đối từ khách mua nhà.
            </p>
            <ul class="b2b-card-list">
              <li><CheckCircle2 size={14} class="text-emerald-400" /> Chọn ngày giờ động thổ, mở móng, cất nóc</li>
              <li><CheckCircle2 size={14} class="text-emerald-400" /> Khảo sát cung tài lộc & phương vị đại cát</li>
            </ul>
          </div>

          <div class="b2b-feature-card highlight">
            <div class="b2b-badge-top">QUÀ TẶNG THƯỢNG LƯU</div>
            <div class="b2b-icon-wrap icon-gift">
              <FileText size={24} />
            </div>
            <h3 class="b2b-card-title">Hồ Sơ Mệnh Lý Hoàng Gia 19 Trang</h3>
            <p class="b2b-card-desc">
              1-Click xuất ấn bản phân tích lá số mệnh chủ sang trọng, đóng bìa cứng bàn giao cùng sổ hồng và chìa khóa nhà — tạo điểm chạm đẳng cấp vượt xa đối thủ cạnh tranh.
            </p>
            <ul class="b2b-card-list">
              <li><CheckCircle2 size={14} class="text-emerald-400" /> Xuất file PDF sắc nét in màu A4 tiêu chuẩn</li>
              <li><CheckCircle2 size={14} class="text-emerald-400" /> Dự báo 10 năm đại hạn & lưu niên từng năm</li>
            </ul>
          </div>

          <div class="b2b-feature-card">
            <div class="b2b-icon-wrap icon-wholesale">
              <Crown size={24} />
            </div>
            <h3 class="b2b-card-title">Gói Mua Sỉ 1.000 XU (Tiết Kiệm 50%)</h3>
            <p class="b2b-card-desc">
              Chỉ 790.000đ sở hữu 1.000 XU không giới hạn thời hạn sử dụng. Tự do xuất 20 cuốn Hồ Sơ Hoàng Gia chuyên sâu hoặc 330 phiên tư vấn mệnh lý AI cao cấp.
            </p>
            <ul class="b2b-card-list">
              <li><CheckCircle2 size={14} class="text-emerald-400" /> Tiết kiệm 50% so với giá nạp bán lẻ</li>
              <li><CheckCircle2 size={14} class="text-emerald-400" /> Kích hoạt tự động tức thì qua SePay VietQR</li>
            </ul>
          </div>
        </div>

        <div class="b2b-cta-wrap">
          <a href={resolve('/wallet')} class="b2b-cta-btn">
            <Zap size={18} />
            <span>Kích Hoạt Gói VIP B2B 1.000 XU (790.000đ)</span>
            <ArrowRight size={18} />
          </a>
          <p class="b2b-cta-note">
            Kích hoạt tức thì qua SePay VietQR • Hạn mức vĩnh viễn không hết hạn
          </p>
        </div>
      </div>
    </section>
...
<style>
  ...
  /* B2B ENTERPRISE REAL ESTATE SECTION */
