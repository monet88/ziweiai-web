...
two numbers, and Luc Hao from six coin-toss line states. Da Luc Nham and Ky Mon
...
- Contract: `createDivinationRequestSchema` gains `castMethod` (default 'time'),
  ...
  for Da Luc Nham / Ky Mon. `meihuaMethodKeys` gains `'number-based'`.
...
1. Add number-casting to all four systems. Rejected: Da Luc Nham / Ky Mon have
