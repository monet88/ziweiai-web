...
// hoặc Tử Vi v1 lưu chuỗi gốc) sang định dạng số Việt hóa.
//
// Copy GIÁ TRỊ từ @ziweiai/core/ziwei/lunar-date (decision 0007: web KHÔNG import
// core — core kéo iztro + ephemeris vào client bundle). Các ký tự Hán dưới đây chỉ
// là KHÓA TRA CỨU để PARSE chuỗi legacy đầu vào; output luôn là số + tiếng Việt nên
// không vi phạm bất biến ngôn ngữ (test quét chỉ chặn Hán ở OUTPUT hiển thị).
