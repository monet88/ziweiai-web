// US-017e: chốt bất biến ngôn ngữ cho copy Xem Tướng (face). Toàn bộ nhãn người dùng phải tiếng
// Việt Latin, 0 ký tự CJK (CJK_TEXT_PATTERN — guard runtime web). US-017f sẽ thêm viCopy.palm.
